  ...
  Widget build(BuildContext context, ref) {
    ...
    final children = [
      AdaptiveSelectTile<LayoutMode>(
        secondary: const Icon(spotifyreIcons.dashboard),
      ...
      AdaptiveSelectTile<ThemeMode>(
        secondary: const Icon(spotifyreIcons.darkMode),
      ...
      SwitchListTile(
        secondary: const Icon(spotifyreIcons.amoled),
      ...
      ListTile(
        leading: const Icon(spotifyreIcons.palette),
      ...
      SwitchListTile(
        secondary: const Icon(spotifyreIcons.colorSync),
