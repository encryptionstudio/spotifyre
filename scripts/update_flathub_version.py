...
REPO = "KRTirtho/spotifyre"
YAML_FILENAME = "com.github.KRTirtho.spotifyre.yml"
...
tar_url = f"https://github.com/{REPO}/releases/download/v{version}/spotifyre-linux-{version}-x86_64.tar.xz"
